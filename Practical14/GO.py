...
plt.pie([DNAcounter,RNAcounter,Proteincounter,CHcounter],explode=None,labels=labels,colors=('r','b','c','g'),autopct='%1.2f%%',pctdistance=0.7,shadow=True, labeldistance=1.2,startangle=0,radius=1.2,counterclock=True,wedgeprops=None,textprops=None,center=(0,0),frame=False)
